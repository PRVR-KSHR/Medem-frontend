        ...
        <div className={styles.inner}>
          <div className={styles.brand}>
            ...
            <div className={styles.social} aria-label="Social links">
              <a href="#" aria-label="Facebook" className={styles.soc}>f</a>
              <a href="#" aria-label="LinkedIn" className={styles.soc}>in</a>
              <a href="#" aria-label="X" className={styles.soc}>x</a>
              <a href="#" aria-label="YouTube" className={styles.soc}>yt</a>
            </div>
          </div>
